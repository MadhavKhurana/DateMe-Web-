...
class Match extends React.Component {
  ...
  likeTheLove = () => {
    this.props.likeTheLove(this.state.users[this.state.index].user._id);
    this.props.done(this.state.users[this.state.index].user._id);
    this.props.matchFound(this.state.users[this.state.index].user._id);
  };
...
export default connect(
  mapStatetoProps,
  { getAlllookingFor, done, likeTheLove, matchFound }
)(Match);
